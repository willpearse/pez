...
integrates phylogenetic, community, environmental and trait data in as %we list these items a few times, lets keep them in the same order
...
\emph{dissimilarity} &  UniFrac \autocite{Lozupone2005}, \emph{PCD} \autocite{Helmus2010}, PhyloSor \autocite{Bryant2008}, Rao's Q \autocite{Rao1982a}\\
  ...
  \emph{trait.asm} & Simulated community structure based on species traits following Helmus2013\\ %Helmus M.R., Mercado-Silva N. & Vander Zanden M.J. (2013). Subsidies to predators, apparent competition and the phylogenetic structure of prey communities. Oecologia, 1-11.

...
test_that("quantile", {
  ...
  expect_that(round(coef(complex.quantile[[1]]$randomisations[[5]]),4), is_equivalent_to(matrix(c(0,0,0.3333,0), nrow=2, ncol=2)))
...
test_that("mantel", {
  ...
  expect_that(round(complex.mantel[[1]]$randomisations[[5]]$statistic,4), equals(-0.0319))

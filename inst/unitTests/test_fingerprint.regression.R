...
test_that("quantile", {
  ...
  expect_that(basic.quantile$evo, is_equivalent_to(rep(1,4)))
  set.seed(123)
...
test_that("mantel", {
  ...
  set.seed(123)
  expect_that(basic.mantel$eco$raw, equals(eco.trait.regression(data, "trialswap", 100, "mantel", altogether=FALSE)))
  set.seed(123)

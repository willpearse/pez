...
\bibitem[{Ackerly(2009)Ackerly}]{Ackerly2009}
  ...
  evolutionary rates versus phylogenetic signal}. \emph{Proc. Natl
    Acad. Sci.} \textbf{106}, 19699–-19706.
...
\bibitem[{Evans \emph{et~al.}(2009)Evans, Smith, Flynn, \& Donoghue}]{Evans2009}
  Evans, M.E.K., Smith, S.A., Flynn, R.S. \& Donoghue, M.J. (2009) 
  {Climate, niche evolution, and diversification of the ``Bird-cage'' evening primroses
(Oenothera, sections Anogra and Kleinia)}. \emph{Am. Nat.} \textbf{173}, 225-–240.

...
#' @description This data set includes macroinvertebrate samples from the Rio Laja, a phylogenetic tree of the taxa and traits that include mean body length and fish feeding preference
#' as in Helmus \emph{et al.} 2013.
#' @docType data
#' @keywords datasets
#' @usage laja

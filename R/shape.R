...
## sensible 'require'-foo to get everything in there

## TODO: I don't like having to 'require' ape when using phylobase,
## but either I'm doing something really stupid with the dependencies
## or phylobase doesn't have a properly setup NAMESPACE. Grrrr.

## TODO: Gamma reference?

#' Calculate shape phylogenetic biodiversity metrics
#' 
#' @param data a \code{comparative.comm} object
#' @param metric specify particular metrics to calculate, default is
#' \code{all}
#' @param which.eigen The eigenvector to calculate for the PhyloEigen
#' metric
...
#' 735-744.
#' @references \code{cadotte.pd} (i.e., \emph{Eed, Hed}) Cadotte M.W.,
